...
for f in admin.js stores.js payments.js organizations.js api-commercial.js api-transactions.js api-payments.js api-features.js cache-stats.js report-guide.js usage-guide.js; do
