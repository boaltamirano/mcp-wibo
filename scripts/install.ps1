...
$srcFiles = @("config.js", "db.js", "store-resolver.js", "api.js", "server.js", "org-list.js")
foreach ($f in $srcFiles) {
    Invoke-WebRequest -Uri "$RAW_URL/src/$f" -OutFile "$INSTALL_DIR\src\$f" -UseBasicParsing
}

$toolFiles = @("admin.js", "stores.js", "payments.js", "organizations.js", "api-commercial.js", "api-transactions.js", "api-payments.js", "api-features.js", "report-guide.js", "usage-guide.js")
